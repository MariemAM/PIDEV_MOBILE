            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        Evenement t = new Evenement(UserSession.getInstance().getUser().getId(),tfName.getText(),tfdesc.getText(),datePickerdd.getDate(),datePickerdf.getDate(),Integer.parseInt(tfnbplaces.getText()),ph.getText());
