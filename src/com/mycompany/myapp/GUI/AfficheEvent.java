    ...
    public AfficheEvent(Form previous)
    {
        ...
        btnannuler.addActionListener(e -> {
           ...
           +t.getPhoto());
            ...
            this.add(new Slider());
            EncodedImage enc = EncodedImage.createFromImage(theme.getImage("lod.gif").scaled(250, 250), false);
            ...
            C1.addAll(imgv,nom,description,date_debut,date_fin,imageQR,nbre_places,btnparticiper,btnannuler);
