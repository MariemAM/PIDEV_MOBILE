 ...
 * @author arij
 */
public class POutOfStock extends MenuForm{
    Form current;
    public POutOfStock( Form prev){
       current=this;
       ...
       for(Produit i:lp){
        ...
        Label prix=new Label(i.getPrix()+" T.N.D");
          ...
          Label qte=new Label("Out Of Stock ");
           qte.getAllStyles().setFgColor(0xb80f0a);
