 ...
 * @author arij
 */
public class ADDP extends MenuForm{
     Form current;
    public ADDP( Form prev){
       current=this;
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    ...
                    try {
                          List<Category> lcd = cs.findCat(catf);
        for(Category c:lcd){
           int idc =c.getId();
         
                        Produit P = new Produit( tfnom.getText(),tfdescription.getText(), tfphoto.getText(),c.getId(),Integer.parseInt( tfqte.getText()),Integer.parseInt(tfprix.getText()) ,Integer.parseInt(tfprix_promo.getText()));
                         ProductServices.getInstance().addProduit(P);
                        new ShopTestForm(current).show();
        }     
