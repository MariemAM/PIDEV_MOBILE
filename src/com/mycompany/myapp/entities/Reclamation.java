...
public class Reclamation {
       private String  contenu , object ;
    private int id , reclamer, user_id;
    private Date date ;

    public Reclamation(Date date, String contenu, String object, int id, int reclamer, int user_id) {
        this.date = date;
    ...
    public Reclamation(String contenu, String object, int reclamer,int user_id) {
        this.contenu = contenu;
        this.object = object;
        this.reclamer = reclamer;
        this.user_id = user_id;
